// @/components/HighlightVideoItem.tsx
"use client";
import { CSSProperties, forwardRef, HTMLAttributes, useContext } from "react";
...
import { VideoPlayerContext } from "@/components/MediaComponents/VideoPlaylist";
...
const HighlightVideoItem = forwardRef<HTMLDivElement, Props>(
  function HighlightVideoItem(
    ...
    const { setCurrentVideo } = useContext(VideoPlayerContext);
