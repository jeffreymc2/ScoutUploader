...
import React from "react"
  ...
  export default function Footer() {
    return (
        <footer className="bg-gradient-to-tl from-blue-500 to-blue-700">
            <div className="mx-auto max-w-7xl px-6 py-5 md:flex md:items-center md:justify-between lg:px-8">
                <div className="flex justify-center space-x-6 md:order-2">
                    {navigation.map((item: { name: string; href: string; icon: (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => JSX.Element }) => (
                ...
                <div className="mt-8 md:order-1 md:mt-0">
                    <p className="text-center text-xs leading-5 text-gray-300">
                        &copy; 2024 Perfect Game Inc. All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
